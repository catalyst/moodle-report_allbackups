...
$string['categorybackupmgmt'] = 'Allow category backup management';
$string['categorybackupmgmt_desc'] = 'Controls the behaviour of the plugin. Tick the box to enable delegation of backups management to roles with the archetype <b>manager</b> in the context of a category.';
$string['categorybackupmgmtonlyexisting'] = 'Show only automatic backups of courses present on this Moodle instance';
$string['categorybackupmgmtonlyexisting_desc'] = 'When using category backups management mode, show only the automatic backups of the courses that are still present on this Moodle installation. This will prevent the users from managing the backups of courses that do not reside under the current category.';
$string['error:categorybackupmgmtmodedisabled'] = 'Category backup management mode is disabled.';
$string['error:wrongcontext'] = 'Invalid contextid parameter. This page is only accessible through <b>SYSTEM</b> or <b>CATEGORY</b> context.';
...
/**
 * The report_allbackups report viewed event.
 *
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'report_allbackups');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the all backups report.";
    }
